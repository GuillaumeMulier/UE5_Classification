...
flextable(tab_knn) %>% 
  ...
  bg(i = 7, j = 1:2, bg = "#0099FF") %>%
  color(i = 7, j = 1:2, color = "white") %>%
  bold(i = 7, j = 1:2) %>% 
  set_caption("Détermination du nombre de voisins optimal par cross-validation")
```

Finalement, le risque de classification minimal est trouvé pour k = 15 et nous retenons donc ce modèle pour la classification par les k plus proches voisins. Les risque de classification est alors de 18.1%.
